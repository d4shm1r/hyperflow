...
ax.plot(z_vals, F_vals, color='royalblue', linewidth=2.5, label="Arithmeflow F(z)")
...
ax.set_title(f'Arithmeflow: x={x}, y={y}')
ax.legend()
ax.grid(True)
st.pyplot(fig)
...
col2.metric("Arithmeflow at z=1.5", f"{sol.sol([1.5])[0][0]:.2f}")
